...
var ScriptDispatchContext = React.createContext(null);
function scriptReducer(state, action) {
    switch (action.type) {
        case "setLoadingStatus":
            return {
                options: __assign({}, state.options),
        ...
        case "resetOptions":
            ...
            return {
                ...
                options: __assign(__assign({}, action.value), { "data-react-paypal-script-id": "" + getScriptID(action.value) }),
            };
        default: {
            return state;
        }
...
function usePayPalScriptReducer() {
    var scriptContext = React.useContext(ScriptContext);
    var dispatchContext = React.useContext(ScriptDispatchContext);
    ...
    var loadingStatus = scriptContext.loadingStatus, restScriptContext = __rest(scriptContext, ["loadingStatus"]);
    var derivedStatusContext = __assign(__assign({}, restScriptContext), { isInitial: loadingStatus === SCRIPT_LOADING_STATE.INITIAL, isPending: loadingStatus === SCRIPT_LOADING_STATE.PENDING, isResolved: loadingStatus === SCRIPT_LOADING_STATE.RESOLVED, isRejected: loadingStatus === SCRIPT_LOADING_STATE.REJECTED });
    return [derivedStatusContext, dispatchContext];
}
var PayPalScriptProvider = function (_a) {
    var options = _a.options, children = _a.children, _b = _a.deferLoading, deferLoading = _b === void 0 ? false : _b;
    function initializeState(_a) {
        var options = _a.options, deferLoading = _a.deferLoading;
        return {
            options: __assign(__assign({}, options), { "data-react-paypal-script-id": "" + getScriptID(options) }),
            loadingStatus: deferLoading
                ? SCRIPT_LOADING_STATE.INITIAL
                : SCRIPT_LOADING_STATE.PENDING,
        };
    }
    var _c = React.useReducer(scriptReducer, { options: options, deferLoading: deferLoading }, initializeState), state = _c[0], dispatch = _c[1];
...
var PayPalButtons = function (_a) {
    ...
    React.useEffect(function () {
        ...
        var paypalWindowNamespace = getPayPalWindowNamespace(options["data-namespace"]);
