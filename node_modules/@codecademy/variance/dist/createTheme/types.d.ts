 ...
 */
export declare type MergeTheme<Base extends AbstractTheme, Next, Unmergable = Record<'breakpoints', Base['breakpoints']>> = Unmergable & {
    [K in keyof (Base & Next)]: K extends keyof Next ? K extends keyof Base ? Base[K] & Next[K] : Next[K] : K extends keyof Base ? Base[K] : never;
};
