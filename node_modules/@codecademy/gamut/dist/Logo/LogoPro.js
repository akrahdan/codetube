...
export var LogoPro = /*#__PURE__*/forwardRef(function LogoPro(_ref, ref) {
  var mode = _ref.mode,
      props = _objectWithoutProperties(_ref, ["mode"]);

  var currentMode = useCurrentMode(mode);
  return /*#__PURE__*/React.createElement(LogoSvg, _extends({}, props, {
    mode: currentMode,
    viewBox: "0 0 139 21.705",
    ref: ref
  }), /*#__PURE__*/React.createElement("title", null, "Codecademy Pro Logo"), /*#__PURE__*/React.createElement("g", {
    fill: "none",
    fillRule: "nonzero"
