...
export declare type TextTags = 'p' | 'span' | 'div';
export declare type TextSizes = 'sm' | 'md' | 'lg';
declare type TextDeprecatedProps = {
    className?: string;
    testId?: string;
    /** Text based tags */
    as?: TextTags;
 ...
 * ```
 */
export declare const TextDeprecated: React.FC<TextDeprecatedProps>;
export {};
