...
var styles = glamor.css(index_1.default['.psds-dropdown__error']);
exports.ErrorIcon = function (_a) {
    var error = _a.error;
    return error ? (react_1.default.createElement("div", __assign({}, styles),
        react_1.default.createElement(ps_design_system_icon_1.WarningIcon, null))) : null;
};
exports.ErrorIcon.displayName = 'Dropdown.ErrorIcon';
