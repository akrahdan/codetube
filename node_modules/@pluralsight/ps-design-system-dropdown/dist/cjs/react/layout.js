...
var styles = {
    layout: function (disabled) {
        return glamor.css(index_1.default[".psds-dropdown"], disabled && index_1.default[".psds-dropdown--disabled"]);
    }
};
exports.Layout = function (_a) {
    ...
    return (react_1.default.createElement("div", __assign({}, styles.layout(disabled), { onKeyDown: onKeyDown }, rest),
        label,
        input,
        button,
        menu,
...
exports.Layout.displayName = 'Dropdown.Layout';
