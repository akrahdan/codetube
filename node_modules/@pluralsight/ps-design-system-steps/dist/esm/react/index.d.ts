...
interface StepsProps extends React.DetailedHTMLProps<React.HTMLAttributes<HTMLDivElement>, HTMLDivElement> {
    counter?: boolean;
...
interface StepProps extends React.HTMLAttributes<HTMLDivElement> {
    ...
    renderMarkerContainer?: (props: React.HTMLAttributes<HTMLDivElement>) => React.ReactElement;
...
interface MarkerProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'ref'> {
    status: ValueOf<typeof Steps.statuses>;
}
declare const Marker: React.ForwardRefExoticComponent<MarkerProps & React.RefAttributes<HTMLDivElement>>;
