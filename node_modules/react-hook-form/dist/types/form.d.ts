...
export declare type UseFormMethods<TFieldValues extends FieldValues = FieldValues> = {
    register: {
        <TFieldElement extends FieldElement<TFieldValues>>(rules?: ValidationRules): (ref: (TFieldElement & Ref) | null) => void;
        (name: FieldName<TFieldValues>, rules?: ValidationRules): void;
        <TFieldElement extends FieldElement<TFieldValues>>(ref: (TFieldElement & Ref) | null, rules?: ValidationRules): void;
        <TFieldElement extends FieldElement<TFieldValues>>(refOrValidationOptions?: FieldName<TFieldValues> | ValidationRules | (TFieldElement & Ref) | null, rules?: ValidationRules): ((ref: (TFieldElement & Ref) | null) => void) | void;
    };
    unregister: (name: FieldName<TFieldValues> | FieldName<TFieldValues>[]) => void;
    watch: {
        (): UnpackNestedValue<TFieldValues>;
        <TFieldName extends string, TFieldValue extends TFieldValues[TFieldName]>(name: TFieldName, defaultValue?: UnpackNestedValue<LiteralToPrimitive<TFieldValue>>): UnpackNestedValue<LiteralToPrimitive<TFieldValue>>;
        <TFieldName extends keyof TFieldValues>(names: TFieldName[], defaultValues?: UnpackNestedValue<DeepPartial<Pick<TFieldValues, TFieldName>>>): UnpackNestedValue<Pick<TFieldValues, TFieldName>>;
        (names: string[], defaultValues?: UnpackNestedValue<DeepPartial<TFieldValues>>): UnpackNestedValue<DeepPartial<TFieldValues>>;
    };
    ...
    getValues: {
        (): UnpackNestedValue<TFieldValues>;
        <TFieldName extends string, TFieldValue extends unknown>(name: TFieldName): TFieldName extends keyof TFieldValues ? UnpackNestedValue<TFieldValues>[TFieldName] : TFieldValue;
        <TFieldName extends keyof TFieldValues>(names: TFieldName[]): UnpackNestedValue<Pick<TFieldValues, TFieldName>>;
    };
