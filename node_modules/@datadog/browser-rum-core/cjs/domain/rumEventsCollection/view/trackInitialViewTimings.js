...
exports.trackFirstInputTimings = exports.trackLargestContentfulPaint = exports.trackFirstContentfulPaint = exports.trackNavigationTimings = exports.trackInitialViewTimings = void 0;
...
function trackFirstContentfulPaint(lifeCycle, callback) {
    ...
    var stop = lifeCycle.subscribe(lifeCycle_1.LifeCycleEventType.PERFORMANCE_ENTRY_COLLECTED, function (entry) {
        if (entry.entryType === 'paint' &&
            ...
            if (entry.startTime > browser_core_1.ONE_DAY) {
                browser_core_1.addMonitoringMessage('FCP > 1 day', {
                    debug: {
...
function trackLargestContentfulPaint(lifeCycle, emitter, callback) {
    ...
    var unsubscribeLifeCycle = lifeCycle.subscribe(lifeCycle_1.LifeCycleEventType.PERFORMANCE_ENTRY_COLLECTED, function (entry) {
        if (entry.entryType === 'largest-contentful-paint' &&
            ...
            entry.startTime < firstHidden.timeStamp) {
            if (entry.startTime > browser_core_1.ONE_DAY) {
                browser_core_1.addMonitoringMessage('LCP > 1 day', {
                    debug: {
