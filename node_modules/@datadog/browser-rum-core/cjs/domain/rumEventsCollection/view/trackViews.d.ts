import { Duration, ClocksState, TimeStamp } from '@datadog/browser-core';
...
export declare function trackViews(location: Location, lifeCycle: LifeCycle, domMutationObservable: DOMMutationObservable, areViewsTrackedAutomatically: boolean, initialViewName?: string): {
