...
function computeRawError(error, handlingStack, startClocks, source) {
    ...
    return tslib_1.__assign(tslib_1.__assign({ startClocks: startClocks,
        source: source, originalError: error }, browser_core_1.formatUnknownError(stackTrace, error, 'Provided', handlingStack)), { handling: browser_core_1.ErrorHandling.HANDLED });
}
