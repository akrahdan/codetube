import { Observable, TimeStamp } from '@datadog/browser-core';
...
export declare function waitIdlePageActivity(lifeCycle: LifeCycle, domMutationObservable: DOMMutationObservable, completionCallback: (params: CompletionCallbackParameters) => void): {
    stop: () => void;
};
export declare function trackPageActivities(lifeCycle: LifeCycle, domMutationObservable: DOMMutationObservable): {
