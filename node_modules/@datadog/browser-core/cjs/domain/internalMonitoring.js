...
exports.setDebugMode = exports.addErrorToMonitoringBatch = exports.addMonitoringMessage = exports.callMonitored = exports.monitor = exports.monitored = exports.resetInternalMonitoring = exports.startInternalMonitoring = void 0;
...
exports.addErrorToMonitoringBatch = addErrorToMonitoringBatch;
...
function logMessageIfDebug(message) {
    if (monitoringConfiguration.debugMode) {
        display_1.display.log('[MONITORING MESSAGE]', message);
    }
}
