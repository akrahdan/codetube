export { DEFAULT_CONFIGURATION, Configuration, UserConfiguration, buildCookieOptions, BeforeSendCallback, } from './domain/configuration';
...
export { startSessionManagement, SESSION_TIME_OUT_DELAY, SESSION_COOKIE_NAME, stopSessionManagement, } from './domain/sessionManagement';
