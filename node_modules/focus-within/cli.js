...
var plugin = postcss.plugin('focus-within', opts => {
...
if (process.argv.length < 3) {
  console.log(['Focus Within\n', '  Transforms CSS with :focus-within {}\n', 'Usage:\n', '  focus-within source.css transformed.css', '  focus-within --in=source.css --out=transformed.css --opts={}', '  echo "@media (prefers-color-scheme: dark) {}" | focus-within\n'].join('\n'));
  process.exit(0);
