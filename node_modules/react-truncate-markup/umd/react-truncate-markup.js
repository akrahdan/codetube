...
var validateTree = function validateTree(node) {
  if (typeof node === 'string' || Object(__WEBPACK_IMPORTED_MODULE_6__atom__["c" /* isAtomComponent */])(node)) {
    return true;
...
var computedStyle = __webpack_require__(13);
