...
var modalSlice_2 = require("state/modals/modalSlice");
exports.RegistrationForm = function (_a) {
    ...
    var resetRecaptcha = function () {
        setDisabled(false);
        setRecaptchaInstanceId(uuid_1.v4());
    };
    var signup = auth_1.useSignupMutation()[0];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    values.csrfmiddlewaretoken = react_cookies_1["default"].load('csrftoken');
                    return [4 /*yield*/, signup(values).unwrap()];
                case 1:
                    user = _a.sent();
                    localStorage.setItem('token', user.token);
                    dispatch(modalSlice_2.hideCurrentModal());
                    setDisabled(true);
                    return [2 /*return*/];
            }
        });
    ...
    var currentPage = props.currentPage, locationType = props.locationType, redirectUrl = props.redirectUrl;
    var signingUpFromExercise = locationType === 'location/EXERCISE';
    ...
    return (react_1["default"].createElement("div", { className: index_module_scss_1["default"].registrationContainer },
        react_1["default"].createElement(gamut_1.GridForm, { className: index_module_scss_1["default"].loginForm, fields: [
                ...
                {
                    name: types_1.UserSubmitKey.USERNAME,
                    label: 'Username',
                    type: 'text',
                    defaultValue: '',
                    size: 12,
                ...
                {
                    name: types_1.UserSubmitKey.PASSWORD1,
                    label: 'Password',
                    type: 'password',
                    tooltip: {
        ...
        react_1["default"].createElement(gamut_1.Text, { className: index_module_scss_1["default"].textDisplay },
            react_1["default"].createElement("p", { className: index_module_scss_1["default"].textCenter },
                ...
                " ",
                react_1["default"].createElement("a", { className: index_module_scss_1["default"].textLink, onClick: function () { return dispatch(modalSlice_1.showModal('login')); } }, "Sign in"),
                "."))));
};
